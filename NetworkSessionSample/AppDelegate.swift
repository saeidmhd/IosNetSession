...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        gai.tracker(withTrackingId: "UA-71912431-4")
   ...
   // MARK: - Core Data stack ios 10 and above
  ...
  /*  // MARK: - Core Data stack xcode 9 and below
    
   lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "mahak-com.coredata" in the application's documents Application Support directory.
